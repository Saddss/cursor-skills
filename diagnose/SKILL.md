...
> **Vendored from [mattpocock/skills](https://github.com/mattpocock/skills) under MIT.** Only the `description` was extended with inference-server triggers; the body is otherwise verbatim. See `LICENSE-MIT-Matt-Pocock.txt`.
