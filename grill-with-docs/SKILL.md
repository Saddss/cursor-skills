...
description: >-
  ...
  project language and documented decisions, or before major inference-stack
...
metadata:
  ...
  adapted_for: Saddss/cursor-skills (Claude XML tags converted to markdown; otherwise verbatim)
---
