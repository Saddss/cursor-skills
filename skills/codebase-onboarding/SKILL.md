...
description: >-
  Launch multiple explore subagents in parallel to investigate architecture,
  data models, APIs, and deployment; synthesize an onboarding document.
  Use when first entering an inference framework repo, benchmark harness, or
  unfamiliar serving stack.
metadata:
  upstream: https://github.com/spencerpauly/awesome-cursor-skills/tree/main/resources/codebase-onboarding
  adapted_for: Saddss/cursor-skills (Claude user-invocable removed; inference triggers added)
---

> **Vendored from [spencerpauly/awesome-cursor-skills](https://github.com/spencerpauly/awesome-cursor-skills).** Pairs with `parallel-exploring` and `zoom-out`.
